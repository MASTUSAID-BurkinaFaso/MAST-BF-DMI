...
public class CcroDto  implements Serializable{
	...
	private HashMap<String,String> admin_url;
	
	private List<String> deceasedPerson;
	...
	public HashMap<String, String> getAdmin_url() {
		return admin_url;
	}
	public void setAdmin_url(HashMap<String, String> admin_url) {
		this.admin_url = admin_url;
	}
	public List<String> getDeceasedPerson() {
		return deceasedPerson;
	}
	public void setDeceasedPerson(List<String> deceasedPerson) {
