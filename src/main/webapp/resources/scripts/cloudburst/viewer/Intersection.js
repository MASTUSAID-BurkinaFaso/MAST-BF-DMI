...
function intersectionPopup(resulttmp,tempInValid)
{
	...
	var Intersection_errors="";
	var Invalid_geometry_errors="";
	var Selected_type="";
	var Number_of_invalid_geometries="";
	var Number_of_intersections="";
	
	if(lang=='en'){
		 Intersection_errors="Intersection errors";
		 Invalid_geometry_errors="Invalid geometry errors";
		 Selected_type="Selected type :";
		 Number_of_invalid_geometries="Number of invalid geometries :";
		 Number_of_intersections="Number of intersections :";
	}
	else if(lang=='fr'){
		
		 Intersection_errors="Erreurs d'intersection";
		 Invalid_geometry_errors="Erreurs de geométrie incorrecte";
		 Selected_type="Type selectionnné :";
		 Number_of_invalid_geometries="Nombre de geométries incorrectes :";
		 Number_of_intersections="Nombre d'intersections :";
	}
	...
	if (resulttmp.length > 0 || tempInValid.length >0) {
		...
		popupInfo += '<div><p><strong>'+Number_of_intersections+resulttmp.length+ '</strong></p>';
		popupInfo += '<p><strong>'+Number_of_invalid_geometries +tempInValid.length+ '</strong></p>';
		popupInfo += '<p><strong>'+Selected_type+spatial_validType+'</strong></p></div>';
		//Info diplay in popup
		popupInfo += '<h3 class="rowhead" style="padding: 5px; padding-left: 26px;"> '+Intersection_errors+'</h3>';
		...
		popupInfo += '<h3 class="rowhead" style="padding: 5px; padding-left: 26px;"> '+Invalid_geometry_errors+'</h3>';
...
if(lang=="en")
	...
	jAlert("Aucune erreur de validation",Alert);
	}
